...
export type LocationType = 'center' | 'manufacturer' | 'customer' | 'in_transit';
...
export type DeviceFormat = 'kit' | 'piece';
...
export interface RepairRecord {
  ...
  manufacturer_invoice_date?: string;
  manufacturer_invoice_estimate?: number;
  manufacturer_invoice_total?: number;
  manufacturer_invoice_gst_rate?: number;
  manufacturer_invoice_base_amount?: number;
...
export interface DashboardStats {
  ...
  center_breakdown?: { center_id: string; center_name: string; count: number }[];
  in_transit_count?: number;
}

export const MOVEMENT_TYPE_LABELS: Record<MovementType, string> = {
  received: 'Patient Dropped Off at Center',
  center_transfer: 'Transferred Between Centers',
